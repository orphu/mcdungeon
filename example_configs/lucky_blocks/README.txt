...
will need to modify the ID setting in items.txt, materials.cfg, and the items/*.yaml
...
The sample YAML files in the items/ directory explicitly specify only drop effects that
